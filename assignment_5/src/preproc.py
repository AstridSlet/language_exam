...
Usage:
    preproc.py --outfile <path-for-output-file>
Example:
    $ python preproc.py --outfile outfile_name.csv
"""
...
emoji_pattern = re.compile("["
        ...
        u"\U0001F600-\U0001F64F"  # below are other specific emojis that weren't captured in the patterns above
...
def clean_text2(text):
    ...
    text = re.sub(r'vaccination', ' ', text) # remove target string 
...
def main():
    ...
    # read data (only the columns specified in col_list)
